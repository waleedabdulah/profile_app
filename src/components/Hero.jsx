...
export default function Hero({ theme }) {
  ...
  return (
    ...
    >
      {/* Three.js canvas — absolutely behind content */}
      <canvas
        ref={canvasRef}
      ...
      <div className="absolute inset-0 z-[1] bg-gradient-to-b from-bg/30 via-transparent to-bg/60 pointer-events-none" />
      ...
      <div className="relative z-10 text-center px-6 max-w-3xl mx-auto">
        ...
        <AnimateIn delay={400} direction="up">
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="#projects"
              className="px-8 py-3 bg-accent text-white font-medium rounded-lg hover:bg-accent-lt transition-colors duration-200"
            >
              View My Work
            </a>
            <a
              href={meta.resumeUrl}
              className="px-8 py-3 border border-border text-muted font-medium rounded-lg hover:border-accent hover:text-accent transition-colors duration-200"
            >
              Download Resume
            </a>
          </div>
        ...
        <div className="flex items-center justify-center gap-6 mt-10">
          ...
          <a href={`mailto:${meta.email}`} aria-label="Email"
            className="text-muted hover:text-accent transition-colors duration-200">
